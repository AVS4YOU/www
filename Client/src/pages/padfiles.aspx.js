        ...
        return (
            ...
            >
                <div className="header">
                    <ImageGQL className="headerBackgroundImage" imageName="pad_files_image.png"
                    ...
                    <div className="header__background-gradient">
                        <div className="header__body header__body_bg">
                            <div className="header__body-wrapper">
                                ...
                                <Text as="h3" className="header__subtitle"
                                      style={{padding: '0'}}>{this.props.t("Use the following PAD files for all AVS4YOU programs")}</Text>
                                <ScrollLink to="padFilesTable" spy={true} smooth={true} offset={-70} duration={500}>
                                    <Button className="header__button header__button_pad" style={{position: "center"}}
                                            textClassName="header__button-text" id="get-all-pad-files_padfiles"
                                            href="https://www.avs4you.com/pads/en/avsvideoconverter.xml">{this.props.t("GET ALL PAD FILES")}</Button>
                                </ScrollLink>
                            </div>
                        </div>
                    </div>
                ...
                <div id="padFilesTable">
                    ...
                    <TabIndex
                        ...
                        hrefTableId="affiliates_padfiles"
                        data={[{
