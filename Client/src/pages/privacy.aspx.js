    ...
    return (
      ...
      >
        ...
        <div className="body-privacy">
          ...
          <Text className="body-privacy__text">
            {this.props.t("Any data collected through avs4you.com,")} <a href="forum.avs4you.com" target="_blank">{this.props.t("forum.avs4you.com")}</a> or www.avs4you.com {this.props.t("and other subdomains of the domain avs4youcom collectively the AVS4YOU Website or AVS Video Editor, AVS Video Converter, AVS Video ReMaker, AVS Audio Editor, AVS Audio Converter, AVS Image Converter, AVS Document Converter, AVS Media Player, AVS Registry Cleaner, AVS Disc Creator, AVS Photo Editor collectively the AVS4YOU Software will be collected by Online Media Technologies Ltd. which is a company formed in London, UK with its principal place of business located at 85 Great Portland, London W1W 7LT, United Kingdomand other subdomains of the domain avs4youcom collectively the AVS4YOU Website or AVS Video Editor, AVS Video Converter, AVS Video ReMaker, AVS Audio Editor, AVS Audio Converter, AVS Image Converter, AVS Document Converter, AVS Media Player, AVS Registry Cleaner, AVS Disc Creator, AVS Photo Editor collectively the AVS4YOU Software will be collected by Online Media Technologies Ltd which is a company formed in London, UK with its principal place of business located at 85 Great Portland, London W1W 7LT, United Kingdom")}
          </Text>
          <Text className="body-privacy__text">
          ...
          <div className="body-privacy__text">
            <Text className="paragraph-text">
            {this.props.t("first and last name – to identify users and display a unique username in AVS4YOU support Forum (“Forum”) associated with user’s Forum account (“Account”) at forum.avs4you.com;")}
            </Text>
            <Text className="paragraph-text">
          ...
          <div className="body-privacy__text">
            ...
            <Text className="paragraph-text">
              {this.props.t("Other data. Please refer to Third-party service providers section of this Policy and the following  link: https://developers.google.com/analytics/resources/concepts/gaConceptsTrackingOverview to learn more.")}
            </Text>
          </div>

          <Text className="body-privacy__text">
            {this.props.t("If you choose not to register or provide Personal Data, you can still use our website anonymously. But you will not be able to access areas that require registration (e.g. you can’t ask questions in support Forum).")}
          </Text>
          <Text className="body-privacy__text">
          ...
          <Text className="body-privacy__text">
            {this.props.t("When you interact with social media buttons (i.e. share, like, tweet, +1 etc) on our website or when you link your Account to or log in through a social media website the social networks may record some of your actions.")}
          </Text>
          ...
          <Text className="body-privacy__text">
              <b>{this.props.t("Right to erasure (Right to be forgotten)")} </b> {this.props.t("You are eligible to delete certain Data from our site and services. Please contact us by sending e-mail at")} <a href="mailto:info@avs4you.com">info@avs4you.com</a> {this.props.t("to do so")}. {this.props.t("Please note, if you choose to delete your Data, it will become unavailable and will be completely deleted in 60 days upon your delete request.")}
          </Text>
          <Text className="body-privacy__text">
          ...
          <div className="body-privacy__text">
            ...
            <Text className="paragraph-text">
              {this.props.t("Functionality. These cookies are used to remember some choices that users make (i.e. search parameters or language settings) and to make your use of our site and services more tailored.")}
            </Text>
