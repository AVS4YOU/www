            ...
            <ModalEgg
                  ...
                  >
                    ...
                    <div className="EventEggContent">                    
                        <Text className="ModalShaerTexth1">Enjoy this spring with<br />a 50% discount</Text>
                        <Text className="ModalShaerTexth2">on AVS Video ReMaker<br />1 Unlimited Subscription</Text>
                        <Text className="ModalShaerTextCoupon"><span>Sunny50</span></Text>
