...
render(){
    ...
    return (
      <Layout 
        ...
        t={this.props.t}
        title="AVS Video Editor 1 Year Subscription"
        metaDescription=""
        metaKeywords=""
      >
        ...
        <div className="headerBackground" style={{marginBottom:"2%", marginTop:"1%"}}>
            <PageContentWrapper>
              ...
              >
                ...
                <Text className="headerText" lineHeight="45px" color="#32393e" fontSize={14} fontWeight={600} as="h1">{this.props.t("License AVS Video Editor 1 Year Subscription")}</Text>
...
export default withI18next({ ns: "common" })(avsVideoEditorYear);
