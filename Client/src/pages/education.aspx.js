            ...
            <ModalEgg
                  ...
                  >
                    ...
                    <div className="EventEggContent">                    
                        <Text className="ModalShaerTexth1">Take advantage<br />of 40% Off</Text>
                        <Text className="ModalShaerTexth2">on AVS4YOU 1 Year<br />Subscription</Text>
                        <Text className="ModalShaerTextCoupon"><span>Bunny40</span></Text>
