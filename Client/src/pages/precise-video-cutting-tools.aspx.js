    ...
    return (
        ...
        <div class="vel_content">
            ...
            <div class="vel_narrow">
                ...
                <div class="vel_description">Trim, cut, split, crop, merge, rotate videos to create impressive movies</div>
        ...
        <div class="vel_narrow">
            ...
            <div class="vel_ee_blocks">
                ...
                <div class="velee_block veleeb_2">
                    ...
                    <div class="velee_description">Eliminate negative effects of your camera shake making video smooth.</div>
                </div>
