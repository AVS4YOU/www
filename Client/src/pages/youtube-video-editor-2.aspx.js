...
<header>
    <div class="lfb_header">
        <a class="lfb_logo" href="https://www.avs4you.com/index.aspx" target="_blank"></a>
        <ul class="topmainmenu max-width-1">
...
<div class="lfb_why_choose">
    <div class="lfb_wc_h">Why choose AVS4YOU</div>
    <div class="lfb_wc_icons">
        <div class="lfb_wc_i lfb_wci_screen">Simple, but feature-rich</div>
        <div class="lfb_wc_i lfb_wci_mp4">Popular video formats</div>
        <div class="lfb_wc_i lfb_wci_cam">Any type of content</div>
        <div class="lfb_wc_i lfb_wci_set">Smart presets</div>
    </div>
</div>
<div class="lfb_steps" id="to_easy_steps">
    <div class="lfb_s_h">4 Steps for creating your captivating video</div>
    <div class="lfb_step lfb_step_1">
        <div class="lfb_img lfb_img_r"><ImageGQL class="lfb_i" imageName="prepare_your_material.png" /></div>
        <div class="lfb_s_text">
            <div class="lfb_st_h">Prepare your material</div>
            <div class="lfb_st_sh">Capture video from your DV/HDV cameras, webcams or VHS cameras. Upload video recordings and video files stored on your PC.</div>
            <ScrollLink to="lfb_step_2" spy={true} smooth={true}>
            <div class="lfb_st_btn to_2">Step 1</div>
            </ScrollLink>
            
        </div>
    </div>
    <div class="lfb_step lfb_step_2" id="lfb_step_2">
        <div class="lfb_img lfb_img_l"><ImageGQL class="lfb_i" imageName="clean_and_assemble.png" /></div>
        <div class="lfb_s_text">
            <div class="lfb_st_h">Clean and assemble</div>
            <div class="lfb_st_sh">Cut unnecessary parts, trim or join video. Remove defects with smart color correction tools and video stabilization.</div>
            <ScrollLink to="lfb_step_3" spy={true} smooth={true}>
            <div class="lfb_st_btn to_3">Step 2</div>
            </ScrollLink>
            
        </div>
    </div>
    <div class="lfb_step lfb_step_3" id="lfb_step_3">
        <div class="lfb_img lfb_img_r"><ImageGQL class="lfb_i" imageName="convert_details.png" /></div>
        <div class="lfb_s_text">
            <div class="lfb_st_h">Convert details into engagement</div>
            <div class="lfb_st_sh">Apply 300+ impressive video, audio and draw effects and transitions (play with 300+ impressive effects and colorful transitions).</div>
            <ScrollLink to="lfb_step_4" spy={true} smooth={true}>
            <div class="lfb_st_btn to_4">Step 3</div>
            </ScrollLink>
            
        </div>
    </div>
    <div class="lfb_step lfb_step_4" id="lfb_step_4">
        <div class="lfb_img lfb_img_l"><ImageGQL class="lfb_i" imageName="launch_your_project.png" /></div>
        <div class="lfb_s_text">
            <div class="lfb_st_h">Launch your project to the orbit</div>
            <div class="lfb_st_sh">Save your project choosing one of specially designed templates depending on the desired quality of the output video.</div>
            <div class="lfb_st_btn"><a href="https://downloads.avs4you.com/distributives/AVSVideoEditor.exe">Download</a></div>
        </div>
    </div>
</div>
