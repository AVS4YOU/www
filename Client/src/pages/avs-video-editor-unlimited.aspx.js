          ...
          <div className="headerBackground" style={{marginBottom:"2%", marginTop:"1%"}}>
            <PageContentWrapper>
              ...
              >
                ...
                <Text className="headerDescription" as="h5" color="#32393e" fontSize={35} fontWeight={900}>{this.props.t("590")}</Text>
                ...
                <Button
                    ...
                    id="buy_avs-video-editor-unlimited"
                ...
                <div className="HeaderListItem" style={{marginLeft:"115px"}}>
                  <Button
                    ...
                    padding="15px 28.5px"
                    textTransform="uppercase"
                    id="download-now1_avs-video-editor-unlimited"
            ...
            <div id="headerCoupon" className="headerContentWrapper">   
              ...
              <div className="buttonsWrapper">
                  <Button
                    ...
                    textTransform="uppercase"
                    id="download-now2_avs-video-editor-unlimited"
                    href="https://downloads.avs4you.com/distributives/AVSVideoEditor.exe">
                      {this.props.t("Download now")}</Button>
                    </div>
            </div>
