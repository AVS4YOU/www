      ...
      >
        <ProductPagesWrapper>
          ...
          <PageContentWrapper>
            ...
            <DownloadScrollButton className="buttonWrapper" href="https://new.avs4you.com/downloads/AVSAudioConverter.exe" to="headerContentWrapper" textDownload={this.props.t("download now")}/>
                ...
                <div className="specificationGrid">
                  <div>
                    ...
                    <div className="systemWrapper">
                      ...
                      <Text as="span" color="#000000" fontSize={16} fontWeight={500} align="left">{this.props.t("Intel / AMD compatible at 1.86 GHz or higher")}</Text>
                    </div>
                    <div className="systemWrapper">
