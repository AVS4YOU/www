        ...
        >
            <ProductPagesWrapper>
                    ...
                    <PageContentWrapper>
                        <div id="headerContentWrapper" className="headerContentWrapper">
                            ...
                            <Text color="#ffffff" align="center" className="headerText" lineHeight="65px"
                                  ...
                                  as="h1">{this.props.t("Free AVS Registry Cleaner")}</Text>
                            <Text color="#ffffff" align="center" className="headerDescription" as="h5"
                                  fontSize={24}>{this.props.t("Make your PC operate clean and fast with Free AVS Registry Cleaner")}</Text>
                            <HeaderDownloadButtons
                                ...
                                margin="auto"
                                id="download-now1_avs-free-registry-cleaner"
                            />
                        </div>
                    </PageContentWrapper>
                    <ImageGQL className="headerImage" imageName="registry_cleaner_header.png"
                              style={{maxWidth: "1564px"}} alt="header-image"/>
                    <ImageGQL className="headerImage mobile" imageName="registry_cleaner_header.png"
                ...
                <PageContentWrapper>
                    ...
                    >
                        <Text
                            className="ListItem">{this.props.t("Scan different registry categories like uninstalled entries, shared DLL's, COM/ActiveX and file extensions")}</Text>
                        <Text
                            className="ListItem">{this.props.t("Clean out temporary Internet files, corrupted applications, and trash files")}</Text>
                    </ContentRowItem>
                    ...
                    >
                        ...
                        <Text
                            className="ListItem">{this.props.t("Schedule time and select file categories for scanning")}</Text>
                    ...
                    >
                        <Text
                            className="ListItem">{this.props.t("AVS Registry Cleaner is compatible with office-, graphics-, anti-virus- and other software installed on your PC")}</Text>
                        <Text
                            className="ListItem">{this.props.t("AVS Registry Cleaner runs under the latest version of Microsoft Windows 10881 including 64bit version")}</Text>
                    </ContentRowItem>
                ...
                <div id="reviews" className="backgroundWrapper">
                    ...
                    <Button className="trustButton" style={{margin: "auto", display: "table"}}
                            id="review_avs-free-registry-cleaner"
                ...
                <Text id="screenshotsCarousel" className="carouselHeader"
                      as="h2">{this.props.t("Free AVS Registry Cleaner")}</Text>
                <ScreenshotsCarousel
