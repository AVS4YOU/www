    ...
    return (
      ...
      >
        <div className="header">
          ...
          <GatsbyLink className="headerLogo" to="/" id="home_installed-pack">
              <LogoWrapper href="/">
              </LogoWrapper>
          </GatsbyLink>
          </div>
              <Text as="h1" className="header__heading installed">{this.props.t("Thank you for installing AVS4YOU Installation Package")}</Text>
                ...
                <table className="header__buy"><Text as="h2" className="header__buy__now"><a id="get-it-now_installed-pack" href={this.props.t(`${this.state.hrefUnlim}`)} style={{color: "#fff"}}>{this.props.t("Get It Now")}</a></Text></table></div></div>
            </div>
        </div>
...
<div className="tipsIcon"><a id="tips-tricks_installed-pack" href="https://www.avs4you.com/guides/index.aspx" style={{color: "#393939"}}>{this.props.t("Tips tricks")}</a></div>
