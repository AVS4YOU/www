    ...
    return (
      ...
      >
        ...
        <div className="header">
          ...
          <GatsbyLink className="headerLogo" to="/" id="home_installed-video-remaker">
              <LogoWrapper href="/">
            ...
            <ImageGQL className="installedSuper" imageName="installed-video-editor-super.png" style={{margin: "auto"}}/>
              ...
              <table style={{margin: '0 auto'}}>
                <InstalledAudioConverterLink id="exclusive-offer-only-today_installed-video-remaker" href={this.props.t(`${this.state.hrefUnlim}`)}>
              ...
              <table style={{margin: '0 auto'}}>
                <InstalledAudioConverterButNow id="buy-now_installed-video-remaker" href={this.props.t(`${this.state.hrefUnlim}`)}>
          ...
          <div className="contact-body__max-width">
            ...
            <div className="contact-body__wrapper">
              ...
              <div className="gift">{this.props.t("Gift")}</div>
                <div className="download-product fix-style1"><InstalledAudioConverterDownloadNow id="download-avs-vc_installed-video-remaker" href="https://downloads.avs4you.com/distributives/AVSAudioConverter.exe">{this.props.t("Download now")}</InstalledAudioConverterDownloadNow></div>
              ...
              <div className="common-info-block">
              <div className="gift">{this.props.t("Gift")}</div>
              <div className="download-product fix-style1"><InstalledAudioConverterDownloadNow id="download-avs-ve_installed-video-remaker" href="https://downloads.avs4you.com/distributives/AVSVideoEditor.exe" style={{color: "#fff"}}>{this.props.t("Download now")}</InstalledAudioConverterDownloadNow></div>
                <Text as="h4" className="common-info-block__headline">
                AVS Video Editor
                </Text>
                <Text className="common-info-block__text">
              ...
              <div className="common-info-block">
                <div className="gift">{this.props.t("Gift")}</div>
                <div className="download-product fix-style1"><InstalledAudioConverterDownloadNow id="download-avs-ae_installed-video-remaker" href="https://downloads.avs4you.com/distributives/AVSAudioEditor.exe">{this.props.t("Download now")}</InstalledAudioConverterDownloadNow></div>
                <Text as="h4" className="common-info-block__headline">
                AVS Audio Editor
                </Text>
                <Text className="common-info-block__text">
              ...
              <div className="common-info-block">
              <div className="gift">{this.props.t("Gift")}</div>
                <div className="download-product fix-style1"><InstalledAudioConverterDownloadNow id="download-avs-ac_installed-video-remaker" href="https://downloads.avs4you.com/distributives/AVSAudioConverter.exe">{this.props.t("Download now")}</InstalledAudioConverterDownloadNow></div>
                <Text as="h4" className="common-info-block__headline">
                AVS Audio Converter
                </Text>
                <Text className="common-info-block__text">
...
<div className="knowledge"><div className="knowledgeIcon"><a id="knowledge-center_installed-video-remaker" href="https://onlinehelp.avs4you.com/avs-video-remaker/" style={{color: "#393939"}}>{this.props.t("Knowledge center")}</a></div>
<div className="tipsIcon"><a id="tips_installed-video-remaker" href="https://www.avs4you.com/guides/video.aspx" style={{color: "#393939"}}>{this.props.t("Tips tricks")}</a></div>
<div className="questionIcon">{this.props.t("Got a question")}
<br/>{this.props.t("Contact our")} <a id="support-team_installed-video-remaker" href="https://support.avs4you.com/login.aspx?_ga=2.17915129.1345987683.1595154508-193195073.1594635509" style={{color: "#393939"}}>{this.props.t("support team")}</a> </div>
</div>
</div>
</Layout>
    );
