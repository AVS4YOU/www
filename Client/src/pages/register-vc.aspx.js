            ...
            <tr className="first-tr">
              ...
              <div className="why-choose-item">
                ...
                <Text className="text" id="text_link">
                  <Link to="/moneyback.aspx" id="moneyback_register-vc">
