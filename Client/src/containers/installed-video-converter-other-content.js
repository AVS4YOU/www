    ...
    <div>
        <div className="header_other">
            ...
            <div className="body-company_other">
              ...
              <div className="carouselItem package_other">
                  <Text>{props.t("5 multimedia programs")}</Text>
                </div>
                <div className="carouselItem unlimited_other">
                  <Text>{props.t("No restrictions")}</Text>
                </div>
                <div  className="carouselItem noWatermark_other">
                  <Text>{props.t("No watermark")}</Text>
                </div>
                <div  className="carouselItem free_other">
                  <Text>{props.t("Free upgrades")}</Text>
                </div>
                <div className="carouselItem secure_other">
