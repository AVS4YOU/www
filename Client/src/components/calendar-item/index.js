...
class CalendarItem extends React.Component {
  ...
  renderButtonSave = (textButton, hrefButtonSave, idButton) => {
    return(
      <>
        <button className="shopButton">
        <a id={idButton} href={hrefButtonSave} target="_blank" download="avs_card_2026.zip">{textButton}</a>
        </button>
      </>
    )
  }
  ...
  renderButtonSaveLetter = (textButton, hrefButtonSaveLetter, idButton) => {
    return(
      <>
        ...
        <a id={idButton} href={hrefButtonSaveLetter} target="_blank" download="avs_letter_2026.zip">{textButton}</a>
        </button>
      </>
    )
  }
