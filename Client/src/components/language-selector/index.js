                                ...
                                this.props.locale !== item.value 
                                    ? <DropdownElement 
                                        ...
                                        href={pageContext
                                            ...
                                            item.value !== "en" && "http://teststatic.avs4you.com/" + item.value + (pageContext.originalPath === "/" ? "/index.aspx" : pageContext.originalPath.replace(/(\/)?$/, ''))
                                            //
                                    ...
                                    <DropdownElement 
                                        ...
                                        href={
                                            pageContext
                                                ...
                                                ? item.value !== "en" && "http://teststatic.avs4you.com/" + item.value + (pageContext.originalPath === "/" ? "/index.aspx" : pageContext.originalPath.replace(/(\/)?$/, ''))
                                                : item.value !== "en" && "http://teststatic.avs4you.com/" + item.value
                                                //
                                        }
                                        langChange={item.value === "en"}
                                        headerText={item.text} 
