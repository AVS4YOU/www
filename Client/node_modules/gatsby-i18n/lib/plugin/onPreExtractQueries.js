...
function () {
  ...
  _regenerator.default.mark(function _callee(_ref, pluginOptions) {
    var store, getNodes, program, fragment, file;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            store = _ref.store, getNodes = _ref.getNodes;
            program = store.getState().program;
            fragment = "\n    import { graphql } from 'gatsby';\n\n    export const localeFragment = graphql`\n      fragment TranslationFragment on ".concat(pluginOptions.translationsConnections || "Locale", "Connection {\n        edges {\n          node {\n            id\n            lng\n            ns\n            data\n          }\n        }\n      }\n    `;\n");
            file = "".concat(program.directory, "/.cache/fragments/@igorko/fragments.js");
            _context.next = 6;
