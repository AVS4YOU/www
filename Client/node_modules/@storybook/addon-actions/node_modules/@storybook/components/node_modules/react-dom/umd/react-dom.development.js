...
function ReactBlockingRoot(container, tag, options) {
...
ReactRoot.prototype.render = ReactBlockingRoot.prototype.render = function (children, callback) {
...
ReactRoot.prototype.unmount = ReactBlockingRoot.prototype.unmount = function (callback) {
  var root = this._internalRoot;
  callback = callback === undefined ? null : callback;
...
function legacyCreateRootFromDOMContainer(container, forceHydrate) {
  ...
  return new ReactBlockingRoot(container, LegacyRoot, shouldHydrate ? {
    hydrate: true
  } : undefined);
}
