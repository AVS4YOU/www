...
### Исправления
* Убрана плашка St. Valentine

## 1.0.25

### Новое
* Добавлена плашка St. Valentine
...
### Исправления
* Убрана плашка Magic Christmas Sale
* Возвращена шапка главной страницы 
* Удалена страница `/avs-christmas.aspx`

## 1.0.17

### Исправления
* Изменены версии, даты релиза и размер файлов на страницах подуктов

## 1.0.16

### Новое
* Добавлена плашка Magic Christmas Sale
* Изменена шапка главной страницы 
* Добавлена страница `/avs-christmas.aspx`

### Исправления
* Добавлена информация о поддержке Windows 11 на страницы продуктов
...
* Добавлена кнопка в блоке отзывов Trustpilot на главной странице и страницах продуктов

### Исправления
* Правка перевода на странице `/es/license-agreement.aspx`
